...
if("TRUE" STREQUAL "TRUE")
  set(tl_detector_SOURCE_PREFIX /udacity/System_Integration_Submission_TeamThinkLikeCar/ros/src/tl_detector)
  set(tl_detector_DEVEL_PREFIX /udacity/System_Integration_Submission_TeamThinkLikeCar/ros/devel)
  ...
  set(tl_detector_INSTALL_PREFIX /udacity/System_Integration_Submission_TeamThinkLikeCar/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tl_detector' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/udacity/System_Integration_Submission_TeamThinkLikeCar/ros/src/tl_detector/${idir}'.  Ask the maintainer 'yousuf <yousuf@todo.todo>' to fix it.")
    endif()
