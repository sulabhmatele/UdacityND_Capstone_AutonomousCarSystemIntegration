...
if("FALSE" STREQUAL "TRUE")
  set(styx_SOURCE_PREFIX /udacity/System_Integration_Submission_TeamThinkLikeCar/ros/src/styx)
  set(styx_DEVEL_PREFIX /udacity/System_Integration_Submission_TeamThinkLikeCar/ros/devel)
  set(styx_INSTALL_PREFIX "")
  set(styx_PREFIX ${styx_DEVEL_PREFIX})
else()
  set(styx_SOURCE_PREFIX "")
  set(styx_DEVEL_PREFIX "")
  set(styx_INSTALL_PREFIX /udacity/System_Integration_Submission_TeamThinkLikeCar/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'styx' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/udacity/System_Integration_Submission_TeamThinkLikeCar/ros/install/${idir}'.  Ask the maintainer 'yousuf <yousuf@todo.todo>' to fix it.")
    endif()
